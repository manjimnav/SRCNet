...
class SCINet(nn.Module):
    def __init__(self, pred_len, seq_len, emb_in = 9, d_model = 1, kernel_size = 5, dropout=0.5, n_layers=3):
        super(SCINet, self).__init__()

        self.input_dim = emb_in
        self.input_len = seq_len
        self.output_len = pred_len
        self.hidden_size = d_model
        self.num_levels = n_layers
        self.groups = 1
        self.modified = True
...
if __name__ == '__main__':
    ...
    parser.add_argument('--positionalEcoding', action='store_false')
